    ...
    jefn.datatree = function (data, parent) {
        ...
        $.each(data,function (i,val) {
            ...
            if (val.childlist.length > 0) {
                ...
                //创建一个子节点li    二级li添加元素！！！！！！！！！！！！！！！！！！
                var liCls = $("<li class='li-relative' treeid='"+val.tid+"'><div class='opera'> <p class='middle'><span></span> 中</p> <p class='low'><span></span> 低</p> <p class='ques'><span></span> 是问题</p> <p class='noques'><span></span> 不是问题</p> <p class='leave'><span></span>遗留问题</p> </div></li>");
                //没有子节点的情况
