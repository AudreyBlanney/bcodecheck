...
def Clint():
        try:
                db = pymysql.connect(host="127.0.0.1", user="root", passwd="4869", db="codecheck", charset='utf8')
        except Exception:
                db = pymysql.connect(host="localhost", user="root", passwd="4869", db="codecheck", charset='utf8')
        return db
