...
CREATE TABLE `obsec_scan_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29733 DEFAULT CHARSET=utf8;
...
CREATE TABLE `obsec_scan_summary` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='扫描数据概述表';
...
CREATE TABLE `obsec_upload_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=59 DEFAULT CHARSET=utf8 COMMENT='用户上传文件信息表';
