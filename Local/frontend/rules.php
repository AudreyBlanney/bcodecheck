...
<body>
  ...
  <div id="io_menu" class="iomenu">
    <span class="btn btn-success btn-file">打开一个规则文件 <input type="file" id="loadDocument" value="Load"/></span>
    <input class="btn btn-success" type="button" id="saveDocument" value="保存"/>
  </div>
