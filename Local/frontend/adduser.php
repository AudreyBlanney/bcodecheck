...
<?php
if(!empty($_POST['submit']) &&  $_POST['submit']!= NULL){
...
<style type="text/css">
.containerw { margin: 65px auto;padding:40px 0;border-radius: 5px; position: relative; width: 40%;background-color: #dbf7f5; }
#content {
  background: #f9f9f9;
...
<nav class="navbar navbar-theme-blue navbar-fixed-top" role="navigation">
    ...
    <div class="container-fluid">
      <div class="row">
          ...
          <h3 class="page-header container">添加用户</h3>
