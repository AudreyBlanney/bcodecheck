      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse" aria-expanded="false" style="height: 1px;">
          <ul class="nav navbar-nav nav-pad">
            ...
            <li class="active"><a href="issues.php">代码分析</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="page-header">
            详细报告<!-- <?php echo $_SESSION['current_scan_report'] ?> -->
              </h3>
...
?>
    ...
    //Issue Type Metrics
        var myChart1 = echarts.init(document.getElementById('chart_vulntype'),'dark');
        myChart1.setOption({
            title: {
              show:true,
                text: '问题类型指标',
        ...
        //Plugin Metrics
        var myChart2 = echarts.init(document.getElementById('chart_lang'),'dark');
        myChart2.setOption({
            title: {
              show:true,
                text: '插件测量',
        ...
        //Severity Metrics
        var myChart3 = echarts.init(document.getElementById('chart_severity'),'dark');
        myChart3.setOption({
            title: {
                show:true,
                text: '安全性程度',
