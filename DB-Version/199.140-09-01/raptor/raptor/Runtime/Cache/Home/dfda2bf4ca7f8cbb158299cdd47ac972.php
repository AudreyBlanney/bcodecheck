...
<div class="container">
    <div class="row rowpiece">
        ...
        <div class="col-xs-4 col-sm-2 col-md-2 col-lg-1 subhead"><a href="<?php echo U('Home/Analysis/issues_bro/info_id/'.$info_id);?>">分览视图</a></div>
        <div class="col-xs-4 col-sm-2 col-md-2 col-lg-1 subhead" style=" background-color:rgba(34,41,48,.6);"><a href="<?php echo U('Home/Analysis/online/info_id/'.$info_id);?>">在线审计</a></div>
    </div>
                    ...
                    <div class="message-left">
                        <div class="level-con">
                            <div class="part4" type="4">
                                <p>忽略</p>
                                <p style="color: #c31f26"><?php echo ($degree_class['忽略']); ?></p>
                            </div>
                            <div class="part4" type="1">
                                <p>高</p>
                                <p style="color: #c31f26"><?php echo ($degree_class['高']); ?></p>
                            </div>
                            <div class="part4" type="2">
                                <p>中</p>
                                <p style="color: #dac82c"><?php echo ($degree_class['中']); ?></p>
                            </div>
                            <div class="part4" type="3">
                                <p>低</p>
                                <p style="color: #199d2b"><?php echo ($degree_class['低']); ?></p>
                            </div>
                            <div class="part4" type="5" style="background: #1f2938">
                                <p>所有</p>
                                <p style="color: #0978b7"><?php echo ($degree_class['所有']); ?></p>
                            </div>
                        </div>
                        <div class="tree-con">
                            <!--滚动条-->
