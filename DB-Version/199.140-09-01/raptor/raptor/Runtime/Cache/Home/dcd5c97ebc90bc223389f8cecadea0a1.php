...
<div class="container">
    <div class="row rowpiece">
        <div class="col-xs-4 col-sm-2 col-md-2 col-lg-1 subhead" ><a id="zong" href="<?php echo U('Home/Analysis/issues/info_id/'.$info_id);?>" style=" background-color:rgba(34,41,48,.6);">总览视图</a></div>
...
<script src="/Public/Js/issues.js"></script>
</body>
</html>