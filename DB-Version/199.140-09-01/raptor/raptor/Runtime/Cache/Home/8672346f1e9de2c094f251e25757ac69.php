        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 usehei" >
            <div class="usemessage">
                <div class="linemessage">
                    ...
                    <span class="markmessage"><?php echo ($user_info['user_name']); ?></span>
                </div>
                <div class="linemessage">
                    <span class="markname">电话：</span>
                    <span class="markmessage"><?php echo ($user_info['phone']); ?></span>
                </div>
                <div class="linemessage">
                    <span class="markname">邮箱：</span>
                    <span class="markmessage"><?php echo ($user_info['email']); ?></span>
                </div>
                <div class="linemessage" style="border-bottom: none">
                    <span class="markname">创建时间：</span>
                    <span class="markmessage"><?php echo ($user_info['register_time']); ?></span>
                </div>
            </div>
        </div>
    </div>
